#!/usr/bin/env python3
"""
Fetch coduri de reducere carVertical de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/carvertical.com
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/carvertical.com"
STORE_NAME = "carVertical"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru carVertical de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-carvertical)"
    }
    try:
